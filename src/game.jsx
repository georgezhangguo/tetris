...
class Game extends React.Component {
    constructor(props) {
        ...
        // this.useAI = true;
        this.interval_ai = props.aiInterval || 50;
        ...
        // aiSeed={
        //     alpha: 0.13106457902211366,
        //     beta: 0.0610822962760082,
        //     gama: -0.1846246009452231,
        //     delta: -0.0375987155019879
        // }
            ...
            <section>
                ...
                <section>
                    <table>
                        ...
                        <tr>
                            <td><input type="radio" disabled={this.props.disableMode} checked={!this.useAI}
                                       value="false" onChange={(e)=> {
                                e.target.blur();
                                this.automation(e.target.value === "true")
                            }}/>人工控制
                            </td>
                            <td><input type="radio" disabled={this.props.disableMode} value="true" checked={this.useAI}
                                       onChange={(e)=> {
                                           e.target.blur();
                                           this.automation(e.target.value === "true")
                                       }}/>AI控制
                ...
                <section className="links">
                    <ul>
                        <li className={window.location.pathname.endsWith("/") || window.location.pathname.endsWith("/index.html") ? "selected" : ""}>
                            <a href="index.html">Tetris</a></li>
                        <li className={window.location.pathname.endsWith("/test.html") ? "selected" : ""}><a
                            href="test.html">单元测试</a></li>
                        <li className={window.location.pathname.endsWith("/evolution.html") ? "selected" : ""}><a
                            href="evolution.html">AI训练</a></li>
                    </ul>
                </section>
                <section>
                    <p>操作说明:空格键加速，方向键左、右控制平移动，上下键控制变形</p>
                    <p>训练模式下不能切换操作模式，全程AI控制</p>
                    <p>Github地址: <a href="https://github.com/hoyt-tian/tetirs" target="_blank">https://github.com/hoyt-tian/tetirs</a>
                    </p>
                    <p>更多说明: <a href="http://www.hoyt-tian.com/tag/tetris/" target="_blank">http://www.hoyt-tian.com/tag/tetris</a>
                    </p>
                </section>
            </section>
        </div>);
